...
<body>
	...
	<%
		...
		try {
			...
			while (rs.next()) {
				...
				PreparedStatement pstmt1=((java.sql.Connection) con).prepareStatement("SELECT * FROM comment where blogname ='"+name+"' and blogdate ='"+date+"'");
	...
	<display:table name="Blog" id="showblog">
